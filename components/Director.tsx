           ...
           <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
             ...
             <div className="lg:w-7/12">
                ...
                <div className="space-y-6 text-lg text-slate-600 leading-relaxed font-light">
                    ...
                    <p>
                        A pioneer in the field of education with rich experience of over two decades, <span className="font-bold text-slate-800">Prince NDA Academy</span> is a unique entity of Prince Edu-Hub. Prince NDA Academy has evolved a pattern of education that is in-tune with the changing needs of today’s leadership and challenges.
                    </p>
