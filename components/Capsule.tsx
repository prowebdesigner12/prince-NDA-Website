...
const Capsule: React.FC = () => {
  return (
    <>
      <PageHeader
        title="NDA Capsule Course"
        subtitle="NDA Preparation Made Easy"
      />
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg border border-slate-200 -mt-32 relative">
            <div className="text-slate-600 leading-relaxed space-y-8">
              ...
              {/* Intro Section */}
              <div>
                <h3 className="text-2xl font-bold text-slate-800 mb-4">NDA Capsule Course - NDA Preparation Made Easy</h3>
                <p className="mb-4">
              ...
              <div>
               ...
               <div className="bg-slate-900 text-white p-8 rounded-lg text-center mt-8">
                    <h3 className="text-2xl font-bold mb-2">PRINCE NDA ACADEMY</h3>
                    <p className="mb-4 text-slate-300">Palwas Road, Sikar - 332001 (Raj.) INDIA</p>
                    
                    <div className="flex flex-col md:flex-row justify-center items-center gap-4 mb-6">
                         <div className="flex items-center gap-2">
                             <PhoneIcon />
                             <a href="tel:9610792222" className="hover:text-red-500">9610792222</a>
                             <span>||</span>
                             <a href="tel:9610872222" className="hover:text-red-500">9610872222</a>
                         </div>
                         <div className="flex items-center gap-2">
                             <MailIcon />
                             <a href="mailto:princendaacademy@gmail.com" className="hover:text-red-500">princendaacademy@gmail.com</a>
                         </div>
                    </div>
                    ...
                    <div className="border-t border-slate-700 pt-6">
                        ...
                        <div className="flex justify-center gap-4">
                            <a href="https://www.facebook.com/PrinceEduHubSikar/" target="_blank" rel="noreferrer" className="hover:text-red-500"><FacebookIcon /></a>
                            <a href="https://www.youtube.com/@PRINCEEDUHUB/" target="_blank" rel="noreferrer" className="hover:text-red-500"><YouTubeIcon /></a>
                            <a href="#" className="hover:text-red-500"><TwitterIcon /></a>
                            <a href="#" className="hover:text-red-500"><LinkedInIcon /></a>
                        </div>
                    </div>
               </div>
