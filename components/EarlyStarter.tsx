...
const EarlyStarter: React.FC = () => {
  return (
    <>
      <PageHeader
        title="Early Starter Course"
        subtitle="For Class 11th Studying Students"
      />
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg border border-slate-200 -mt-32 relative">
            <div className="text-slate-600 leading-relaxed space-y-8">
              ...
              {/* Intro Section */}
              <div>
                <h3 className="text-2xl font-bold text-slate-800 mb-4">Start Early, Achieve More</h3>
                <p className="mb-4">
              ...
              <div>
                 ...
                 <p className="mb-4">
                    Prince NDA Academy offers a fully equipped Library, Computer Lab, Conference Room, Auditorium, SSB Room, Basketball Court, Football ground, Volleyball ground, dedicated Obstacle course, Individual obstacles( as per SSB pattern and standards) and vast open grounds to encourage fitness among candidates as endurance and stamina are a pre-requisite for a success at the SSB. Discipline is given utmost importance and daily schedule is kept close to best practices adopted in our defence forces.
                 </p>
                 <p className="mb-4">
