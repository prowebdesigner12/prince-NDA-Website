...
const GalleryCampus: React.FC = () => {
    const images = [
        "https://princesainikschool.com/images/campus/campus/1.JPG",
        "https://princesainikschool.com/images/campus/campus/2.JPG"
    ];
    ...
    return (
        <>
            <PageHeader
                ...
                subtitle="Princenda Academy Campus Gallery"
            />
            <section className="py-20 bg-slate-50">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 -mt-32 relative max-w-4xl mx-auto">
