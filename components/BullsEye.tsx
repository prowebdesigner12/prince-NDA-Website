...
const BullsEye: React.FC = () => {
  return (
    <>
      <PageHeader
        title="Bull's Eye Course"
        subtitle="For Class 12th Studying Students"
      />
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg border border-slate-200 -mt-32 relative">
            <div className="text-slate-600 leading-relaxed space-y-8">
              ...
              {/* Intro Section */}
              <div>
                <h3 className="text-2xl font-bold text-slate-800 mb-4">Bulls Eye Batch – Your Target, Our Mission</h3>
                <p className="mb-4">
